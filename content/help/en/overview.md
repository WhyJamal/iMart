...
**Vol-Mart** is a full store management system (ERP): sales, warehouse, cash register, staff and reports — all in one place.
...
Retail businesses with one or several store locations — each staff member gets access to the sections they need based on their role (Owner, Admin, Manager, Cashier, etc).

---

Details for each section will be available from the other topics in this window or via the "?" button on the relevant page.
